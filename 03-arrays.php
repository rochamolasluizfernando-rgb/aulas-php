...
?>
    ...
    <ul>
        ...
        <li>Estamos na unidade na ciadade de <?= FILIAIS[0] ?></li>
    </ul>

    <h2>Array associativo</h2>
    <p>Lista de dados baseada em uma chave associativa (na prática, é um nome/identificação que 
    você dá), e um valor para ela (o dado em si).</p>
<?php 
    $curso = [
