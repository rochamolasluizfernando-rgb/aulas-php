...
<head>
    ...
    <title>Funções para Arrays</title><link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.8/dist/css/bootstrap.min.css" 
...
<body>
    ...
    ?>
        ...
        <h2>extract()</h2>
        <p>Extrai chaves associativas para variável</p>
    <?php 
    ...
    ?>
        ...
        <h2>array_unique()</h2>
        <p>Gera um novo array removendo elementos duplicados/repetidos em 
        um array.</p>
    <?php 
    ...
    $servicosConcluidos = array_filter(
        $servicos, fn($servico) => $servico["status"] === "Concluído"
    );
    ?>
